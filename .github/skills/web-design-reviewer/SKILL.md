...
2. **Component-based Search** - Identify components from element text or structure
...
See [references/framework-fixes.md](references/framework-fixes.md) for framework-specific fix techniques.
